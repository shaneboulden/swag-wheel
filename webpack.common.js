    ...
    plugins: [
      ...
      new CopyPlugin({
        patterns: [
          ...
          { from: './images/developer.png', to: 'images' },
          { from: './images/operations.png', to: 'images' },
          { from: './images/security.png', to: 'images' },
          { from: './images/redhat-logo.svg', to: 'images' },
          { from: './images/cyberark-logo.png', to: 'images' },
        ]
      })
    ],
    resolve: {
